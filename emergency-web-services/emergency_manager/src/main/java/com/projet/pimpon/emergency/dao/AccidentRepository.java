...
public interface AccidentRepository extends JpaRepository<Accident, Integer> {
    ...
    @Transactional
    @Modifying
    @Query(value = "update emergency.accident set accident_intensity = :intensity, team_id = :teamId, accident_status = :accidentStatus, accident_coordinates = cast(:coordinates as POINT) where accident_id = :id", nativeQuery = true)
